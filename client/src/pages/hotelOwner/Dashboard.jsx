  ...
  const fetchDashboardData = async () => {
    try {
      ...
      if (error.response) {
            ...
            toast.error(`Network Error: ${error.message || 'Could not connect to the server.'}`);
        }
  }
}
  ...
  return (
    <div>
      <Title
        ...
        font="outfit"
        title="Dashboard"
        subtitle="Monitor your roomlistings, track bookings and analyze
      ...
      <div className="flex gap-4 my-8">
        <div className="bg-primary/3 border border-primary/10 rounded flex p-4 pr-8">
          ...
          <div className="flex flex-col sm: mi-4 font-medium">
            <p>Total Revenue</p>
            <p className="text-neutral-400 text-base px-3">

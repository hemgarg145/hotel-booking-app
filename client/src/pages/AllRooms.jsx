...
const AllRooms = () => {
  ...
  const filteredRooms = useMemo(() => {
    return rooms
      .filter(
        (room) => matchesRoomType(room) && matchesPriceRange(room) && filterDestination(room)
      )
      .sort(sortRooms);
    ...
    <div className="flex flex-col-reverse lg:flex-row items-start justify-between pt-28 md:pt-35 px-4 md:px-16 lg:px-24 xl:px-32">
      ...
      <div className="flex-1">
        ...
        {filteredRooms.length === 0 && (
          <p className="text-gray-500 mt-10">No rooms found for selected filters.</p>
        )}
      ...
      <div className="bg-white w-80 border border-gray-300 text-gray-600 lg:sticky lg:top-20 max-lg:mb-8 lg:mt-16 rounded-md">
        <div
        ...
        >
          ...
          <div className="text-xs cursor-pointer">
            ...
            <span onClick={clearFilters} className="hidden lg:block hover:text-red-500">
              CLEAR
            </span>
          </div>
        </div>
